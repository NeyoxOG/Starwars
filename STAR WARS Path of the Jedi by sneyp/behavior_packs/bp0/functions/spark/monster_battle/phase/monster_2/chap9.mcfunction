...
execute if score .timer .monster_battle matches 11 positioned 8953.5 48.00 5756.5 run dialogue change @e[type=spark:holo_obi_wan,c=1] spark:monster_arena.obiwan.end_2
...
execute if score .npc .monster_battle matches 1 if score .tmp_timer Tmp_mb_timer matches 510 if score "Monster_Battle_Arena" SS_achievements matches 1 if score .monster_1_complete .monster_battle matches 1 run function spark/achievement/trigger/monster_battle_post
execute if score .npc .monster_battle matches 1 if score .tmp_timer Tmp_mb_timer matches 510 run scoreboard players set .monster_2_complete .monster_battle 1
